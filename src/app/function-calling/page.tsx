...
import { FunctionCaller } from "~/components/function-calling/function-caller";
      ...
      <SidebarInset>
        <div className="flex flex-col h-screen bg-gradient-to-b from-background to-background/95">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <h1 className="text-sm font-semibold">Function Calling</h1>
          ...
          <main className="flex-1 overflow-hidden">
            <div className="h-full animate-in fade-in slide-in-from-bottom-4 duration-1000 ease-out">
              <div className="relative h-full overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-tr from-primary/5 via-primary/0 to-primary/5 pointer-events-none" />
                  <div className="container mx-auto p-6">
                    <h1 className="text-2xl font-bold mb-6">Function Calling Demo</h1>
                    <FunctionCaller />
                  </div>
              </div>
            </div>
